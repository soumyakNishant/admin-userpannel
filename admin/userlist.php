...
{				?>	
										<tr>
                                            ...
                                            <td><?php echo htmlentities($result->whatsapp);?></td>
                                            <td><?php echo htmlentities($result->batch);?></td>
                                            <td><?php echo htmlentities($result->py);?></td>
                                            <td><?php echo htmlentities($result->company);?></td>
                                            <td><?php echo htmlentities($result->location);?></td>
                                             <td><?php echo htmlentities($result->jy);?></td>
                                             <td><?php echo htmlentities($result->post);?></td>
                                             <td><?php echo htmlentities($result->gate);?></td>
                                             <td><?php echo htmlentities($result->yapl);?></td>
                                            <td>
